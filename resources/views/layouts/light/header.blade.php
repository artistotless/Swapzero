                ...
                <li>
                	<a class="dropdown-item" href="http://steam365.ru#">
                      ...
                      <div class="notification-content">
                      	...
                      	<h6 class="text-warning">Пополните резервы!</h6>
    ...
    <li class="nav-item dropdown menu_user">
          <a class="nav-link dropdown-toggle" id="userDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="menu-nav list_none">
                <li><a href="{{ route('myprofile') }}"><i class="icon-user"></i><span>Мой профиль</span></a></li>
                ...
                <li><div class="dropdown-divider"></div></li>
                <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="icon-logout icons">
                </i>Выйти</a></li>
            </ul>
          </div>
        </li>
...
@endif
       ...
       <li class="nav-item  menu-notification">
