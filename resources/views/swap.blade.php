...
"><img src="{{ asset('public/index_files/qiwi.png') }}" alt="Twitter" style="height: 43px !important;height: auto;"><span style="
    margin-top: 3px;
">QIWI RUB</span></a>
                                        </li>
                                        <li class="">
                                           <a href="javascript:void(0);" data-tag="Яндекс Деньги" style="
"><img src="{{ asset('public/index_files/yandex_dengi_product_icon_rgb.png') }}" alt="Twitter" style="height: 36px !important;height: auto;/* margin-top: 10px; */"><span style="
...
"><img src="https://www.webmoney.ru/img/icons/wmlogo_flat_48.png?1542983030" alt="Twitter" style="height: 33px !important;height: auto;"><span>WMR</span></a> 
                                           ...
                                           <a href="javascript:void(0);" data-tag="Rapida Online" style="/* background-color: rgba(94, 129, 177, 0.2); */"><img src="{{ asset('public/index_files/rapida_logo.png') }}" alt="Twitter" style="height: 33px !important;height: auto;"><span>Рапида Online</span></a> 
                                    	</li>
                                        
                                        
                                        <li class="">
                                           <a href="javascript:void(0);" data-tag="Visa/MasterCard" style="/* background-color: rgba(185, 17, 17, 0.2); */"><img src="{{ asset('public/index_files/mc_symbol.svg') }}" alt="Twitter" style="height: 31px !important;height: auto;/* margin-top: 10px; */"><img src="https://upload.wikimedia.org/wikipedia/commons/5/53/Visa_2014_logo_detail.svg" alt="Twitter" style="height: 20px !important;height: auto;/* margin-top: 10px; */"><span>MC/Visa RUB</span></a> 
                                    	</li>
                                    <li class="">
